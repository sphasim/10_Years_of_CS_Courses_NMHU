...
class CourseAdmin(admin.ModelAdmin):
    fieldsets = [('Course Number', {'fields': ['course_number'], 'classes': ['collapse']}), ('Course Type', {'fields': ['course_type'], 'classes': ['collapse']}), ('Course Title', {'fields': ['course_title']}), ('Subject', {'fields': ['subject'], 'classes': ['collapse']}), ]
    # inlines = [OfferingInline]
    list_display = ('course_number', 'course_type', 'course_title', 'subject', )
